...
<div class="w3-content" style="max-width:1532px;">
  ...
  <div class="w3-row-padding w3-large w3-center" style="margin:32px 0">
    <div class="w3-third"><i class="fa fa-map-marker w3-text-red"></i> Five star,Mumbai</div>
    <div class="w3-third"><i class="fa fa-phone w3-text-red"></i> Phone:+917776806103</div>
    <div class="w3-third"><i class="fa fa-envelope w3-text-red"></i> Email:Kjluparkar09@gmail.com</div>
  </div>
  ...
  <div class="w3-container" id="contact">
    ...
    <i class="fa fa-map-marker w3-text-red" style="width:30px"></i> Mumbai,Maharashtra<br>
    <i class="fa fa-phone w3-text-red" style="width:30px"></i> Phone:+917776806103 <br>
    <i class="fa fa-envelope w3-text-red" style="width:30px"> </i> Email: kjluparkar09@gmail.com<br>
    <form action="/action_page.php" target="_blank">
...
<footer class="w3-padding-32 w3-black w3-center w3-margin-top">
  ...
  <p>Powered by <a href="https://google.co.in" target="_blank" class="w3-hover-text-green">Kajal Uparkar</a></p>
</footer>
